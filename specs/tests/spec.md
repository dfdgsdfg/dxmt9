...
type: "Spec"
title: "Tests Spec"
description: "Tests spec, ownership, ordering, and evidence mapping."
tags: [specs, tests, spec]
---
...
Current status snapshots and failure groups belong in `specs/tests/gap.md`; the
...
│   └── bridge/
│       ├── chunk_record_layout_spec.cpp
│       ├── chunk_record_validation_spec.cpp
