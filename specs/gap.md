...
| Vendor FOURCC / dependent-texture / mipmap upload policy | ⚠️ | scaffolded via 6 PE conformance entries (`tests/conformance/d3d9/d3d9_conformance_vendor_policy.c`) — explicit unsupported HRESULT documented for INTZ/FETCH4/RESZ; TEXBEM/TEXDEPTH/test_mipmap_upload deferred to NATIVE/SR follow-up. Policy decisions are now PE-captured even though runtime evidence remains deferred. |
