...
| Verification | partial | [verification/gap](verification/gap.md) | [verification/log](verification/log.md) | TLA+ and deterministic native verification shortfalls; bounded Render Tape Clear/FULL_SNAPSHOT DrawRun/parallel-join refinement is green, while production promotion evidence remains open. |
