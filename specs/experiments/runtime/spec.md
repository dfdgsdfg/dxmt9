---
type: "Spec"
title: "Experiments Runtime Spec — Wine, Prefix, External Apps"
description: "Experiments / Runtime spec, ownership, ordering, and evidence mapping."
tags: [specs, experiments, runtime, spec]
---

# Experiments Runtime Spec — Wine, Prefix, External Apps
...
digraph migrate_sfiv {
  ...
  s6[shape=box, label="run SFIV through run_experiment.py\n(resolve + bootstrap; per-app wrapper removed 2026-07-29)"];
