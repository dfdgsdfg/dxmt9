...
- `shader/requirements.md` for shader IR, analysis passes, MSL emission, FFP key
  semantics, half-pixel and alpha-test rewrite contracts, and precision /
  VSOut policy (`R-CORE-SHADER-*`).
...
creating a real D3D9 device, loading `winemetal_dxmt9.so`, or submitting work to Metal.
