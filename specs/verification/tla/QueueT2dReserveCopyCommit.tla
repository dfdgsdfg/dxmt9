...
(* The modeled submitDrawRunBatchImpl carrier is retired. Ordinary final  *)
(* append remains under CommandQueue::mutex_. The model retains failure   *)
(* modes that any future reservation design must exclude before narrowing *)
(* that lock:                                                             *)
(*                                                                         *)
