 ...
 *   d3d9/queries/spec.md §2  Sequence ID fence mechanism
 *   d3d9/queries/spec.md §3  EVENT query; deadlock-free flush+spin
 *
 * Properties verified:
 ...
 * Named explicitly to match the requirement in d3d9/queries/spec.md §3.
 *)
NoDeadlockOnFlushSpin ==
  \A q \in QueryIds :
