...
CommitRows == <<
  ...
  [phase |-> "Sealed", event |-> "BridgeFailed", next |-> "Sealed", action |-> "Retry", preserveRetryBytes |-> TRUE, commandAccepted |-> FALSE, objectDestroy |-> FALSE, resetBuilder |-> FALSE, advanceWarmEpoch |-> FALSE],
