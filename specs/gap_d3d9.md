...
| GetFrontBufferData | ❌ | ❌ | ⚠️ | ❌ | `d3d9_pe_device_child_misc.cpp:510` | `return D3DERR_INVALIDCALL`; `test_visual_multisample_get_front_buffer_data_policy` exercises the policy edge |
