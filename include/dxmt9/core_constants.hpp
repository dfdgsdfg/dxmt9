...
inline constexpr u32 kStreamSourceIndexedData = 0x40000000u;
inline constexpr u32 kStreamSourceInstanceData = 0x80000000u;
inline constexpr u32 kStreamSourceFrequencyMask = 0x3fffffffu;
...
inline constexpr u32 RS_MULTISAMPLE_MASK = 162;
