...
// SHADER_SOURCE_COPY, DESTROY_SHADER} = 0..3, and bridge entries start
// at DXMT9_WINEMETAL_BRIDGE_OP_BASE = SHADER_COUNT = 4.
...
static_assert(DXMT9_WINEMETAL_CALL_DESTROY_SHADER == 3,
              "shader call opcodes must occupy slots 0..3 in order");
static_assert(DXMT9_WINEMETAL_BRIDGE_OP_BASE == 4,
              "bridge entry table starts at slot 4 (after shader calls)");
