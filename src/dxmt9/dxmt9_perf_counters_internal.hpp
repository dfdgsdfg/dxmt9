...
struct Counters {
  ...
  std::array<std::atomic<std::uint64_t>,
             static_cast<std::size_t>(DirectChunkSlotReplayDisposition::Count)>
      directChunkSlotReplayRaws{};
  std::array<std::atomic<std::uint64_t>,
             static_cast<std::size_t>(DirectChunkSlotReplayDisposition::Count)>
      directChunkSlotReplayRecords{};
  std::array<std::atomic<std::uint64_t>,
             static_cast<std::size_t>(DirectChunkSlotReplayDisposition::Count)>
      directChunkSlotReplayWireBytes{};
  std::array<std::atomic<std::uint64_t>,
  ...
  std::atomic<std::uint64_t> directSlotCapacityLeaseGenerationAdvances{0};
  std::atomic<std::uint64_t> directSlotCapacityLeaseRetainedBytes{0};
  std::atomic<std::uint64_t> directSlotCapacityLeaseRetainedPeakBytes{0};
  std::atomic<std::uint64_t> directSlotCapacityLeaseStagedBytes{0};
  std::atomic<std::uint64_t> directSlotCapacityLeaseStagedPeakBytes{0};
  ...
  std::atomic<std::uint64_t> renderPartitionRequestedDefault{0};
  std::atomic<std::uint64_t> renderPartitionRequestedIdentity{0};
  std::atomic<std::uint64_t> renderPartitionRequestedSerial{0};
  std::atomic<std::uint64_t> renderPartitionRequestedParallel{0};
  std::atomic<std::uint64_t> renderPartitionRequestedInvalid{0};
  std::atomic<std::uint64_t> renderPartitionResolvedIdentity{0};
  std::atomic<std::uint64_t> renderPartitionResolvedSerial{0};
  std::atomic<std::uint64_t> renderPartitionResolvedParallel{0};
  std::atomic<std::uint64_t> parallelPassConsidered{0};
  std::atomic<std::uint64_t> parallelPassEligible{0};
  std::atomic<std::uint64_t> parallelPassSelected{0};
  std::atomic<std::uint64_t> parallelPassFallbackNoPlan{0};
  std::atomic<std::uint64_t> parallelPassFallbackUnsealed{0};
  ...
  std::atomic<std::uint64_t> parallelPassStage2bDraws{0};
  std::atomic<std::uint64_t> parallelPassBindingRejectPsoMissing{0};
  std::atomic<std::uint64_t> parallelPassBindingRejectStage2Table{0};
  std::atomic<std::uint64_t> parallelPassBindingRejectResourceArray{0};
  ...
  std::atomic<std::uint64_t> parallelPassEconomicsMinChild128Plus{0};
  std::atomic<std::uint64_t> parallelPassEconomicsChildren2{0};
  std::atomic<std::uint64_t> parallelPassEconomicsChildren3To4{0};
  std::atomic<std::uint64_t> parallelPassEconomicsChildren5To8{0};
  std::atomic<std::uint64_t> parallelPassEconomicsChildren9To16{0};
  ...
  std::atomic<std::uint64_t> parallelPassShadowSealed{0};
  std::atomic<std::uint64_t> parallelPassShadowEligible{0};
  std::atomic<std::uint64_t> parallelPassShadowEligibleMax{0};
  std::atomic<std::uint64_t> parallelPassShadowChildren{0};
  std::atomic<std::uint64_t> parallelPassShadowChildrenMax{0};
  std::atomic<std::uint64_t> parallelPassShadowDraws{0};
  std::atomic<std::uint64_t> parallelPassShadowDrawsMax{0};
  ...
  std::atomic<std::uint64_t> cpuReadyRetainedHeadFreshAttempts{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadActiveRenderAttempts{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadHeld{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadFreshHeld{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadActiveRenderHeld{0};
  ...
  std::atomic<std::uint64_t> cpuReadyRetainedHeadFreshSuccessorReady{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadActiveRenderSuccessorReady{0};
  ...
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectBorrowShape{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectPayloadInvalid{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectTerminalSuffixOwned{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectPresent{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectSourceCompatibility{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectAdmission{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectCapacitySnapshot{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectWritingSuccessorMissing{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectWritingSuccessorInvalid{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadRejectReservationRace{0};
  std::atomic<std::uint64_t> cpuReadyNextSourceIntentArmed{0};
  std::atomic<std::uint64_t> cpuReadyNextSourceIntentCanceled{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadIntentSelected{0};
  std::atomic<std::uint64_t> cpuReadyRetainedHeadIntentSuccessorReady{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixFreshPrefixes{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixActiveRenderPrefixes{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixFreshJoined{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixActiveRenderJoined{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixFreshNaturalDrains{0};
  std::atomic<std::uint64_t> cpuReadyTerminalSuffixActiveRenderNaturalDrains{0};
  ...
  std::atomic<std::uint64_t> cpuReadySupplyLegacyReplayEntryToPublish{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyReplayEntryToPublishNs{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyReplayEntryToPublishMaxNs{0};
  PercentileRing cpuReadySupplyLegacyReplayEntryToPublishRing;
  std::atomic<std::uint64_t> cpuReadySupplyLegacyPublishToDequeue{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyPublishToDequeueNs{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyPublishToDequeueMaxNs{0};
  PercentileRing cpuReadySupplyLegacyPublishToDequeueRing;
  std::atomic<std::uint64_t> cpuReadySupplyArenaReplayEntryToPublish{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaReplayEntryToPublishNs{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaReplayEntryToPublishMaxNs{0};
  PercentileRing cpuReadySupplyArenaReplayEntryToPublishRing;
  std::atomic<std::uint64_t> cpuReadySupplyArenaPublishToDequeue{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaPublishToDequeueNs{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaPublishToDequeueMaxNs{0};
  PercentileRing cpuReadySupplyArenaPublishToDequeueRing;
  std::atomic<std::uint64_t> cpuReadySupplyAttributionMisses{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyReplayEntryMisses{0};
  std::atomic<std::uint64_t> cpuReadySupplyLegacyPublishToDequeueMisses{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaReplayEntryMisses{0};
  std::atomic<std::uint64_t> cpuReadySupplyArenaPublishToDequeueMisses{0};
  std::atomic<std::uint64_t> cpuReadySupplyLedgerOverflows{0};
  ...
  std::atomic<std::uint64_t> processMemorySamples{0};
  std::atomic<std::uint64_t> processMemoryQueryFailures{0};
  std::atomic<std::uint64_t> processMemoryRssBytes{0};
  std::atomic<std::uint64_t> processMemoryRssPeakBytes{0};
  std::atomic<std::uint64_t> processMemoryVmBytes{0};
  std::atomic<std::uint64_t> processMemoryVmPeakBytes{0};
  std::atomic<std::uint64_t> processMemoryPhysicalFootprintBytes{0};
  std::atomic<std::uint64_t> processMemoryPhysicalFootprintPeakBytes{0};
  std::atomic<std::uint64_t> processMemoryLow4MappedBytes{0};
  std::atomic<std::uint64_t> processMemoryLow4MappedPeakBytes{0};
  std::atomic<std::uint64_t> processMemoryLow4LargestGapBytes{0};
  std::atomic<std::uint64_t> processMemoryLow4LargestGapMinBytes{0};
