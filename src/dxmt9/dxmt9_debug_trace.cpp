...
bool optimizeOpaqueDepthIndexCache() {
  // Candidate construction can dominate the encode wall on dynamic-index
  // workloads even when replay offload is active. Keep the reorder provider
  // explicit until pre-build economy and bounded-work gates are proven.
  static const bool v =
