...
dxmt9_u64 dxmt9_provider_service_compile_shader_marshaled(const Dxmt9WinemetalCompileShaderParams* params);
...
void dxmt9_provider_service_destroy_shader_marshaled(const Dxmt9WinemetalDestroyShaderParams* params);
