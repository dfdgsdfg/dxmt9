...
static const struct test_case tests[] =
{
    ...
    {"scene_begin_end_matrix_policy", test_scene_begin_end_matrix_policy},
    {"vertex_declaration_fvf_policy", test_vertex_declaration_fvf_policy},
    {"fvf_decl_management", test_fvf_decl_management},
    {"get_set_vertex_declaration_refcount_policy",
            test_get_set_vertex_declaration_refcount_policy},
    {"get_declaration_roundtrip_policy",
            test_get_declaration_roundtrip_policy},
    {"fvf_decl_conversion_roundtrip_policy",
            test_fvf_decl_conversion_roundtrip_policy},
    {"vertex_declaration_alignment_policy",
            test_vertex_declaration_alignment_policy},
    {"get_rt_bounds_policy", test_get_rt_bounds_policy},
    {"begin_end_state_block_policy", test_begin_end_state_block_policy},
    {"device_caps_roundtrip_policy", test_device_caps_roundtrip_policy},
    {"get_display_mode_policy", test_get_display_mode_policy},
    {"lost_device_cooperative_policy", test_lost_device_cooperative_policy},
    {"reset_hresult_matrix_policy", test_reset_hresult_matrix_policy},
    {"reset_resources_policy", test_reset_resources_policy},
    {"resource_access_base_pool_policy",
            test_resource_access_base_pool_policy},
    {"resource_access_ex_pool_policy",
            test_resource_access_ex_pool_policy},
    {"vertex_buffer_read_write", test_vertex_buffer_read_write},
    {"qi_base_to_ex", test_qi_base_to_ex},
    {"qi_ex_to_base", test_qi_ex_to_base},
    {"scene_ex_begin_end_policy", test_scene_ex_begin_end_policy},
    ...
    {"stretch_rect_npot_dimension_policy",
            test_stretch_rect_npot_dimension_policy},
    {"stretch_rect_format_conversion_policy",
            test_stretch_rect_format_conversion_policy},
