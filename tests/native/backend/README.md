...
| `pipeline_lifecycle_observer_spec.cpp` | Bounded source-to-reclaim lifecycle, completion/Present/occupancy, admission/reclaim wake, and Present-only wedge (`R-BACK-2.88`, `R-VERIF-2.23`) |
