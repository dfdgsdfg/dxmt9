...
| `mutation_composition_observer_spec.cpp` | Source-qualified mutation observation, generation/use distance, conservative range candidates, barriers, dead chains, and failure conservation (`R-BACK-44.9`–`44.11`) |
