...
| `render_tape_spec.cpp` | Frame-tape v2 bootstrap/object/mutation/control/Present closure, verified blob catalogue, embedded production wire validation, and deterministic replay-sink ordering (`R-HARN-REPLAY-7.2`–`7.8`, `R-VERIF-6.6`) |
