...
| `render_tape_spec.cpp` | Frame-tape v1 bundle layout, event/object closure, embedded production wire validation, and deterministic replay-sink ordering (`R-HARN-REPLAY-7.2`–`7.8`, `R-VERIF-6.6`) |
