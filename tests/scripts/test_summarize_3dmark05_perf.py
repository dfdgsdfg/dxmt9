...
class Summarize3DMark05PerfTests(unittest.TestCase):
    def test_encoder_breakdown_fields_are_parsed_and_written(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("| 7 | 3 | rgb=SrcAlpha,InvSrcAlpha,Add; sep=0; write=0xf | 1 | 1 | 4,096 | 2..2 | 1/4,096 | 1/4,096 | 1 | 0 |", summary)
            self.assertIn("### Alpha Blend Signature Runs", summary)
            self.assertIn("| 7 | 3 | 2 | 2 | rgb=SrcAlpha,InvSrcAlpha,Add; sep=0; write=0xf | 1 | 4,096 | 1/4,096 | 1 | 0 | 1 |", summary)
