...
def summarize_run(label: str, encoders_csv: Path, probe_csv: Path | None) -> dict[str, Any]:
    ...
    out: dict[str, Any] = {
        ...
        "candidate_primitive_bucket_64_255": int(sum_field(rows, "indexed_cache_opt_candidate_primitive_bucket_64_255")),
        "candidate_primitive_bucket_256_1023": int(sum_field(rows, "indexed_cache_opt_candidate_primitive_bucket_256_1023")),
        "candidate_primitive_bucket_1024_4095": int(sum_field(rows, "indexed_cache_opt_candidate_primitive_bucket_1024_4095")),
        "candidate_primitive_bucket_4096_plus": int(sum_field(rows, "indexed_cache_opt_candidate_primitive_bucket_4096_plus")),
        "verdict": verdict,
    }
...
CSV_FIELDS = [
    ...
    "candidate_primitive_bucket_64_255",
    "candidate_primitive_bucket_256_1023",
    "candidate_primitive_bucket_1024_4095",
    "candidate_primitive_bucket_4096_plus",
    "probe_draw_logging",
    "probe_draw_rows",
    "probe_eligible_rows",
    "probe_applied_rows",
