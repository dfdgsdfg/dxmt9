...
RUN_COUNTERS = (
    ...
    "chunk_publish_reason_draw_continuation",
    ...
    "chunk_publish_commands_draw_continuation",
    ...
    "encode_session_carry_source_entries",
    "encode_session_carry_source_entry_active_render",
    "encode_session_carry_source_entry_active_blit",
    "encode_session_carry_source_entry_pending_clear",
    "encode_session_carry_first_draw_continue_active",
    "encode_session_carry_first_draw_begin_pass",
    "encode_session_carry_first_draw_split_rt",
    "encode_session_carry_first_draw_split_hazard",
    "encode_session_carry_first_draw_split_other",
    "encode_session_carry_active_entry_first_draw_continue_active",
    "encode_session_carry_active_entry_first_draw_begin_pass",
    "encode_session_carry_active_entry_first_draw_split_rt",
    "encode_session_carry_active_entry_first_draw_split_hazard",
    "encode_session_carry_active_entry_first_draw_split_other",
    "encode_session_carry_active_entry_lost_active_before_first_draw",
    "encode_session_carry_active_entry_lost_active_before_first_draw_final",
    "encode_session_carry_active_entry_lost_active_before_first_draw_rt",
    "encode_session_carry_active_entry_lost_active_before_first_draw_hazard",
    "encode_session_carry_active_entry_lost_active_before_first_draw_clear",
    "encode_session_carry_active_entry_lost_active_before_first_draw_surface_copy",
    "encode_session_carry_active_entry_lost_active_before_first_draw_stretch_rect",
    "encode_session_carry_active_entry_lost_active_before_first_draw_readback",
    ...
    "submit_draw_run_batch_input_runs",
    "submit_draw_run_batch_emitted_runs",
    "submit_draw_run_batch_segments",
...
def write_markdown(
    ...
    publish_reason_rows = (
        ...
        ("map-wait", "chunk_publish_reason_map_wait",
         "chunk_publish_commands_map_wait"),
        ("draw-continuation", "chunk_publish_reason_draw_continuation",
         "chunk_publish_commands_draw_continuation"),
    ...
    if sampled_frames:
        ...
        open_cb_frame_rows = (
            ...
            ("session source entries", "encode_session_carry_source_entries"),
            (
                "session source entries: active render",
                "encode_session_carry_source_entry_active_render",
            ),
            (
                "session source entries: active blit",
                "encode_session_carry_source_entry_active_blit",
            ),
            (
                "session source entries: pending clear",
                "encode_session_carry_source_entry_pending_clear",
            ),
            (
                "session first draw: continue active",
                "encode_session_carry_first_draw_continue_active",
            ),
            (
                "session first draw: begin pass",
                "encode_session_carry_first_draw_begin_pass",
            ),
            (
                "session first draw: split RT",
                "encode_session_carry_first_draw_split_rt",
            ),
            (
                "session first draw: split hazard",
                "encode_session_carry_first_draw_split_hazard",
            ),
            (
                "session first draw: split other",
                "encode_session_carry_first_draw_split_other",
            ),
            (
                "active-entry first draw: continue active",
                "encode_session_carry_active_entry_first_draw_continue_active",
            ),
            (
                "active-entry first draw: begin pass",
                "encode_session_carry_active_entry_first_draw_begin_pass",
            ),
            (
                "active-entry first draw: split RT",
                "encode_session_carry_active_entry_first_draw_split_rt",
            ),
            (
                "active-entry first draw: split hazard",
                "encode_session_carry_active_entry_first_draw_split_hazard",
            ),
            (
                "active-entry first draw: split other",
                "encode_session_carry_active_entry_first_draw_split_other",
            ),
            (
                "active-entry lost before first draw",
                "encode_session_carry_active_entry_lost_active_before_first_draw",
            ),
            (
                "active-entry lost before first draw: final",
                "encode_session_carry_active_entry_lost_active_before_first_draw_final",
            ),
            (
                "active-entry lost before first draw: RT",
                "encode_session_carry_active_entry_lost_active_before_first_draw_rt",
            ),
            (
                "active-entry lost before first draw: hazard",
                "encode_session_carry_active_entry_lost_active_before_first_draw_hazard",
            ),
            (
                "active-entry lost before first draw: clear",
                "encode_session_carry_active_entry_lost_active_before_first_draw_clear",
            ),
            (
                "active-entry lost before first draw: surface copy",
                "encode_session_carry_active_entry_lost_active_before_first_draw_surface_copy",
            ),
            (
                "active-entry lost before first draw: stretch rect",
                "encode_session_carry_active_entry_lost_active_before_first_draw_stretch_rect",
            ),
            (
                "active-entry lost before first draw: readback",
                "encode_session_carry_active_entry_lost_active_before_first_draw_readback",
            ),
            (
                "active-entry lost before first draw: color fill",
                "encode_session_carry_active_entry_lost_active_before_first_draw_color_fill",
            ),
            (
                "active-entry lost before first draw: present",
                "encode_session_carry_active_entry_lost_active_before_first_draw_present",
            ),
            (
