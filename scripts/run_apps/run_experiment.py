...
PE_RECORDER_COUNTER_PATTERN = re.compile(
    ...
    r"pe_recorder_(?:stats|gap_call_stats|gap_tail_stats|"
    r"gap_body_stats|gap_between_call_stats|gap_transition_stats|"
    r"gap_name_transition_stats|gap_callsite_stats)\s+(.*)$"
)
