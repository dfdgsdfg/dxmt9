...
[[present-pacing-encode-session-wait-start-cpuready-publish.168]] then tests
...
[[present-pacing-encode-session-ordinary-source-append.169]] then validates a
...
[[present-pacing-encode-session-semantic-prefix.170]] then lets the selector
...
[[present-pacing-encode-session-selector-counters.171]] (present-pacing H171)
...
enqueue-during-wait.
[[present-pacing-encode-session-selector-wait-phase.172]] (present-pacing H172)
...
that wait.
[[present-pacing-encode-session-ordinary-head-start.174]] (present-pacing H174)
...
[[present-pacing-encode-session-source-class-counters.176]] (present-pacing
...
Metal work. [[present-pacing-encode-session-active-entry-loss.177]] then shows
...
[[present-pacing-encode-session-draw-continuation-source.178]] creates explicit
...
active-entry loss `0`). [[present-pacing-encode-session-batch-run-source-boundary.179]]
