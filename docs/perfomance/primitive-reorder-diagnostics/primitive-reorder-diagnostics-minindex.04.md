...
· [mini-replay-bisection](../mini-replay-bisection/index.md) (geometry-locked depth-input replay harness) ·
[index-cache-locality](../index-cache-locality/index.md) (semantic-safe cache-aware successor) ·
[index-reuse-measurement](../index-reuse-measurement/index.md) (LRU miss model) · [hidden-backend-storage](../hidden-backend-storage/index.md).
