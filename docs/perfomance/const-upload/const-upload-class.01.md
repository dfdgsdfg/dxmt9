...
**Related.** [const-upload](index.md) · next: [const-upload-volatility.01](const-upload-volatility.01.md) ·
[state-churn-encode](../state-churn-encode/index.md) (stream/IB churn measured in the same run) ·
[hidden-backend-storage](../hidden-backend-storage/index.md) (the GPU bucket this CPU traffic is not).
