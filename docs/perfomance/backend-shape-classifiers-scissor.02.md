...
**Related.** [[backend-shape-classifiers]] · expands [[backend-shape-classifiers-scissor.01]] · confirms [[hidden-backend-storage]] · related [[backend-shape-classifiers-cull.02]] (same capture campaign).
