...
- [baselines-frame50.05 - Capture-Delay-Aware 120s Watchdog Scout](baselines-frame50.05.md)
- [baselines-frame60.04 - Low-Overhead Recovery Scout After FPS-Zero Observation](baselines-frame60.04.md)
- [baselines-frame50.04 - Watchdog-Cleanup No-Gputrace Scout](baselines-frame50.04.md)
- [baselines-frame60.03 - Current Visual-Coupling Frame60 No-Gputrace Scout](baselines-frame60.03.md)
- [baselines-frame50.03 - Current Timeout No-Gputrace Scout](baselines-frame50.03.md)
- [baselines-visual-capture.02 - v0.0.1 Historical Screenshot Diff Triage](baselines-visual-capture.02.md)
- [baselines-gputrace-preflight.02 - Current gputrace and System Trace Preflight](baselines-gputrace-preflight.02.md)
