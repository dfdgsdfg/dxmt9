...
**Related.** [[primitive-reorder-diagnostics]] · prior reverse-class results:
[[primitive-reorder-diagnostics-split.03]] · next:
[[primitive-reorder-diagnostics-minindex.02]] (cache-aware successor) ·
[[index-reuse-measurement]] (LRU16/32/64 miss model) ·
[[index-cache-locality]] (the semantic-safe cache-aware path this motivates).
