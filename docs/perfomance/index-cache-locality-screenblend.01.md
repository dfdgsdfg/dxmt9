...
**Related.** [[index-cache-locality]] · next: [[index-cache-locality-screenblend.02]]
(later cache-based screen-blend approach) · [[primitive-reorder-diagnostics]]
(the reverse-order origin) · [[hidden-backend-storage]] · [[baselines]] (measure-index-cache).
