...
**Related.** [[state-churn-encode]] · prev: [[state-churn-encode-statedelta.01]] ·
next: [[state-churn-encode-statedelta.03]] ·
[[state-churn-encode-binding.01]] (the override fix this motivated).
