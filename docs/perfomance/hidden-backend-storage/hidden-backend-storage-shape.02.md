...
**Related.** [[hidden-backend-storage]] · prev: [[hidden-backend-storage-shape.01]]
· [[vsout-layout]] · [[index-cache-locality]] ·
[[index-cache-locality-screenblend.04]] · [[tvb-mechanism-proof]].
