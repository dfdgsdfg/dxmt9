...
**Related.** [[index-cache-locality]] · next: [[index-cache-locality-identity.02]]
· [[index-reuse-measurement]] (the `DXMT9_MEASURE_INDEX_REUSE` family) ·
[[mini-replay-bisection]] (consumes the identity rows) · [[primitive-reorder-diagnostics]]
