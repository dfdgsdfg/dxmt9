...
**Related.** [index-cache-locality](index.md) · prev: [index-cache-locality-opaque.01](index-cache-locality-opaque.01.md)
· next: [index-cache-locality-opaque.03](index-cache-locality-opaque.03.md) · [tvb-mechanism-proof](../tvb-mechanism-proof/index.md) (mechanism that makes it real).
