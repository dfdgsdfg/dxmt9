...
replay plus its no-gputrace sanity/timeout scouts, and the mid-investigation
...
flowchart TD
  ...
  class F120,F50,F50san,F50to,F60,RunLevel accepted
...
[[baselines-frame50.03]] scouts prove the runtime shape is stable enough to
