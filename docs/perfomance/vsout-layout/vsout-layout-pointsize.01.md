...
**Related.** [vsout-layout](index.md) · narrower follow-up to [vsout-layout-varying.01](vsout-layout-varying.01.md) · motivated [vsout-layout-position.01](vsout-layout-position.01.md) · [hidden-backend-storage](../hidden-backend-storage/index.md) · [shader-codegen](../shader-codegen/index.md).
