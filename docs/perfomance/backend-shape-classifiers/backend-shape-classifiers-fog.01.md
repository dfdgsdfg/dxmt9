...
**Related.** [[backend-shape-classifiers]] · companion to [[backend-shape-classifiers-texture.01]] (the other secondary fragment-cost classifier) · refutes fog as the [[hidden-backend-storage]] owner · refutes [[vsout-layout]] fogFactor width as the owner.
