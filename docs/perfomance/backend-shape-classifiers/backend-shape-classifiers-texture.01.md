...
**Related.** [backend-shape-classifiers](index.md) · companion to [backend-shape-classifiers-fog.01](backend-shape-classifiers-fog.01.md) · refutes texture sampling as the [hidden-backend-storage](../hidden-backend-storage/index.md) owner · refutes [vsout-layout](../vsout-layout/index.md) visible-width-alone.
