...
[[backend-shape-classifiers-cull.02]]).
...
**Related.** [[backend-shape-classifiers]] · first in the cull sequence, detailed in [[backend-shape-classifiers-cull.02]] · paired with [[backend-shape-classifiers-scissor.01]] in the same summary · confirms [[hidden-backend-storage]].
