...
**Related.** [[backend-shape-classifiers]] · directly followed [[backend-shape-classifiers-cull.03]] · the strongest confirmation of [[hidden-backend-storage]] scaling · motivates the accepted [[index-cache-locality]] win (reduce VS invocations within the indexed path) · related [[index-reuse-measurement]].
