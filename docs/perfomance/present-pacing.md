...
- The current EncodeSession/open-render-encoder carrier is a default-off
  ...
  wait-active versus `840` wait-inactive. The next implementation owner is
  earlier CPU-ready/source attachment to an open render encoder or
  producer/replay cadence, not another selector relaxation.
