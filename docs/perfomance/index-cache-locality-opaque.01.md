...
**Related.** [[index-cache-locality]] · next: [[index-cache-locality-opaque.02]]
· [[index-reuse-measurement]] (LRU32/cache-miss model) ·
[[hidden-backend-storage]] (the bucket this reduces) · [[snapshot-cache]] (layout-stride baseline).
