...
([[primitive-reorder-diagnostics-reverse.11]]) with fewer reordered draws? Asks
...
[[primitive-reorder-diagnostics-reverse.10]]) moved VS write only `+0.03%`.
...
([[primitive-reorder-diagnostics-reverse.17]]) fails to reproduce it.

**Related.** [[primitive-reorder-diagnostics]] · tooling: [[primitive-reorder-diagnostics-reverse.09]]
· from: [[primitive-reorder-diagnostics-reverse.11]] · contrasts: [[primitive-reorder-diagnostics-reverse.10]]
· narrows to: [[primitive-reorder-diagnostics-reverse.13]] · current rerun: [[primitive-reorder-diagnostics-reverse.17]]
