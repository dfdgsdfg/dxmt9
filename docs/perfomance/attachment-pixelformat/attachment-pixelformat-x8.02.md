...
**Related.** [attachment-pixelformat](index.md) · narrows the broad attempt [attachment-pixelformat-x8.01](attachment-pixelformat-x8.01.md), motivates the shader alpha-fill companion [attachment-pixelformat-x8.03](attachment-pixelformat-x8.03.md) · shares the encoder-breakdown surface with [state-churn-encode](../state-churn-encode/index.md).
