...
**Related.** [[state-churn-encode]] · next: [[state-churn-encode-expand.02]] ·
[[state-churn-encode-stream.03]] (flagged auto-expand as a separate amplifier) ·
[[index-cache-locality]] (the accepted indexed-path GPU win is locality, not
expansion).
