...
**Related.** [state-churn-encode](index.md) · validated by [state-churn-encode-binding.01](state-churn-encode-binding.01.md) ·
...
[const-upload](../const-upload/index.md) (const-upload remains the larger separate break class).
