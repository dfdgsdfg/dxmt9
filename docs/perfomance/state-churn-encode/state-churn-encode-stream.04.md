...
**Related.** [state-churn-encode](index.md) · state-churn-encode-stream.03 ·
state-churn-encode-binding.01 · [hidden-backend-storage-shape.11](../hidden-backend-storage/hidden-backend-storage-shape.11.md) ·
