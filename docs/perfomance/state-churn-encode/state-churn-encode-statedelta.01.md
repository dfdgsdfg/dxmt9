...
**Related.** [state-churn-encode](index.md) · next: [state-churn-encode-statedelta.02](state-churn-encode-statedelta.02.md) ·
[state-churn-encode-drawrun.01](state-churn-encode-drawrun.01.md) (the parent break families) ·
[const-upload](../const-upload/index.md) (const-upload still dominates type breaks).
