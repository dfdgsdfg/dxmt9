...
**Related.** [[state-churn-encode]] · prev: [[state-churn-encode-statedelta.02]] ·
[[state-churn-encode-binding.01]] (the accepted override CPU win) ·
[[const-upload]] (the larger, separate const-upload break class).
