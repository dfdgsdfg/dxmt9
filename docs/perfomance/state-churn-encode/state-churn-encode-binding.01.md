...
**Related.** [state-churn-encode](index.md) · motivated by [state-churn-encode-statedelta.03](state-churn-encode-statedelta.03.md) ·
...
[hidden-backend-storage](../hidden-backend-storage/index.md) (GPU bottleneck unmoved).
