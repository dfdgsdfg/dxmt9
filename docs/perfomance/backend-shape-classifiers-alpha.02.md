...
**Related.** [[backend-shape-classifiers]] · follows [[backend-shape-classifiers-alpha.01]], precedes the precise class-only [[backend-shape-classifiers-alpha.03]] · confirms [[hidden-backend-storage]] · motivates [[mini-replay-bisection]] row-local approach.
