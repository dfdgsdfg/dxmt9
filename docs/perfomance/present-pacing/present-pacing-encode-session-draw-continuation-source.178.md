...
related: docs/perfomance/present-pacing.md, docs/perfomance/present-pacing/present-pacing-encode-session-active-entry-loss.177.md, specs/backend/design.md, specs/backend/requirements.md
---
