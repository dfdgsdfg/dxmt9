...
related: docs/perfomance/present-pacing.md, docs/perfomance/present-pacing/present-pacing-encode-session-writer-active-cpuready-publish.162.md, docs/perfomance/present-pacing/present-pacing-encode-session-producer-cpuready-command-limit.163.md, docs/perfomance/present-pacing/present-pacing-encode-session-active-wait-cpuready-append.165.md, specs/backend/design.md, specs/backend/requirements.md
---
