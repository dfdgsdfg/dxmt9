...
related: docs/perfomance/present-pacing.md, docs/perfomance/present-pacing/present-pacing-encode-session-open-cb-present-tail-split.164.md, specs/backend/design.md, specs/backend/requirements.md
---
