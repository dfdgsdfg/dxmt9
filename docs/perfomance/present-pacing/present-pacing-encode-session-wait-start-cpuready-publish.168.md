...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-pending-wait-state.167.md, docs/perfomance/present-pacing/present-pacing-encode-session-combined-cpuready-append.166.md, specs/backend/design.md, specs/backend/requirements.md
---
