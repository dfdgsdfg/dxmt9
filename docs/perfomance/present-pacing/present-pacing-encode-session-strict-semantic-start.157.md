...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-ready-preempt-release.155.md, docs/perfomance/present-pacing/present-pacing-encode-session-prepresent-initboundary.156.md, specs/backend/spec.md, specs/backend/requirements.md
---
