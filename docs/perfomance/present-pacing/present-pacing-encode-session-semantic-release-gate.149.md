...
related: docs/perfomance/present-pacing.md, docs/perfomance/present-pacing/present-pacing-encode-session-pass-streaming-runtime.147.md, docs/perfomance/present-pacing/present-pacing-encode-session-multisource-storeproof.148.md, specs/backend/design.md, specs/backend/requirements.md
---
