...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-semantic-prefix.170.md, docs/perfomance/present-pacing/present-pacing-encode-session-ordinary-source-append.169.md, specs/backend/design.md, specs/backend/requirements.md
---
