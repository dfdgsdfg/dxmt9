...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-semantic-release-gate.149.md, docs/perfomance/present-pacing/present-pacing-encode-session-pass-streaming-runtime.147.md, specs/backend/design.md, specs/backend/requirements.md
---
