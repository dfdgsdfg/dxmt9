...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-current-smoke.152.md, docs/perfomance/present-pacing/present-pacing-encode-session-wait-stage-durations.151.md, specs/backend/design.md, specs/backend/requirements.md
---
