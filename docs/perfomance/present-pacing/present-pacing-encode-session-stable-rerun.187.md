...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-draw-continuation-command-floor.186.md, specs/backend/spec.md, specs/backend/requirements.md
---
