...
related: docs/perfomance/present-pacing.md, docs/perfomance/present-pacing/present-pacing-encode-session-writer-active-cpuready-publish.162.md, docs/perfomance/present-pacing/present-pacing-encode-session-writer-active-slot-shape.161.md, specs/backend/design.md, specs/backend/requirements.md
---
