...
related: docs/perfomance/present-pacing/index.md, docs/perfomance/present-pacing/present-pacing-encode-session-wait-start-cpuready-publish.168.md, docs/perfomance/present-pacing/present-pacing-encode-session-pending-wait-state.167.md, specs/backend/spec.md, specs/backend/requirements.md
---
