...
**Related.** [[index-cache-locality]] · prev: [[index-cache-locality-identity.01]]
· [[hidden-backend-storage]] (the `2236.981MiB`, `1266B/VS inv` evidence) ·
[[mini-replay-bisection]] · [[index-reuse-measurement]] · [[vsout-layout]] (184B ruled out).
