...
**Related.** [[attachment-pixelformat]] · follows the R32F probe [[attachment-pixelformat-r32f.01]] and motivates the broad X8 attempt [[attachment-pixelformat-x8.01]] · shares the `DXMT9_PERF_ENCODER_BREAKDOWN` instrumentation surface with [[state-churn-encode]] · informs [[render-pass-store]].
