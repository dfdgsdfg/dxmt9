...
end-to-end** runs (SFIV, 3DMark, DX9 SDK samples) and **synthetic
...
Wild apps (SFIV / 3DMark) test the whole pipeline simultaneously and
...
- Do **not** drop wild-app benchmarks. SFIV / 3DMark / SDK samples remain
