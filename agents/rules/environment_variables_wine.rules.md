...
| `DXMT_3DMARK06_ARGS` / `DXMT_3DMARK06_RESULT_FILE` | Override the complete 3DMark06 argument string and optionally append the final positional `.3dr` result path. A raw override takes precedence over `DXMT_3DMARK06_LANE`, receives no automatic headless suffix, and is recorded as lane `custom` |
